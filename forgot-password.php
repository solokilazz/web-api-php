...
if ($user) {
    ...
    $link = "<a href='http://192.168.1.105:3000/reset_password?email="
        . $email . "&token=" . $token . "'>Click to reset password</a>";
    $mail = new PHPMailer();
    $mail->CharSet = "utf-8";
    $mail->isSMTP();
    $mail->SMTPAuth = true;
    $mail->Username = "hoangphucnguyenluu@gmail.com";
    $mail->Password = "hjmwaqqidvalugsd";
    $mail->SMTPSecure = "ssl";
    $mail->Host = "ssl://smtp.gmail.com";
    $mail->Port = "465";
    $mail->From = "hoangphucnguyenluu@gmail.com";
    $mail->FromName = "Nguyễn Lưu Hoàng Phúc";
